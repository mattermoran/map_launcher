...
/// The iOS implementation of [MapLauncherPlatform].
class MapLauncherIOS extends MapLauncherPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('map_launcher_ios');

  /// Registers this class as the default instance of [MapLauncherPlatform]
  static void registerWith() {
    MapLauncherPlatform.instance = MapLauncherIOS();
  }
